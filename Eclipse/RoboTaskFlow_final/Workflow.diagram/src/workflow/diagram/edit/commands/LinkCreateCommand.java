...
public class LinkCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	private final Workflow container;
	...
	*/
	public boolean canExecute() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints().canCreateLink_4001(getContainer(), getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Link newElement = WorkflowFactory.eINSTANCE.createLink();
	...
	* @generated
	*/
	private static Workflow deduceContainer(EObject source, EObject target) {
