 ...
 * @generated
 */
public class QuestionQuestionAnswersCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getQuestion_Answers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getQuestionQuestionAnswersCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Answer2EditPart.VISUAL_ID == WorkflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getQuestionQuestionAnswersCompartment_7004SemanticChildren((View) getHost().getModel());
