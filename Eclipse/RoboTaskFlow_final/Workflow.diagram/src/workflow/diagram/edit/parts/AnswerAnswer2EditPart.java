 ...
 * @generated
 */
public class AnswerAnswer2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AnswerAnswer2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Answer_3007, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.AnswerAnswer2EditPart.VISUAL_ID));
		}
		return parser;
	}
