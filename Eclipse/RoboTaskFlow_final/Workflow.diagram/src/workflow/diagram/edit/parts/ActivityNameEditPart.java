...
public class ActivityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Activity_2002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
