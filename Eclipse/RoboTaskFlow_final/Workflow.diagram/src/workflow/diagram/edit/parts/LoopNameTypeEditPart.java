 ...
 * @generated
 */
public class LoopNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Loop_2001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.LoopNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
