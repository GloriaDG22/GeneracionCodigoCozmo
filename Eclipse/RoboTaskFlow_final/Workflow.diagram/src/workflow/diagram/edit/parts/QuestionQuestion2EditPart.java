 ...
 * @generated
 */
public class QuestionQuestion2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuestionQuestion2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Question_3006, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.QuestionQuestion2EditPart.VISUAL_ID));
		}
		return parser;
	}
