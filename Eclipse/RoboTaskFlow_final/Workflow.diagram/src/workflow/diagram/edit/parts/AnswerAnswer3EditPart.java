 ...
 * @generated
 */
public class AnswerAnswer3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AnswerAnswer3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Answer_3008, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.AnswerAnswer3EditPart.VISUAL_ID));
		}
		return parser;
	}
