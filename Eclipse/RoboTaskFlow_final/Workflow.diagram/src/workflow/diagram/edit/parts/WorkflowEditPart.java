...
import workflow.diagram.edit.commands.WorkflowCreateShortcutDecorationsCommand;
import workflow.diagram.edit.policies.WorkflowCanonicalEditPolicy;
import workflow.diagram.edit.policies.WorkflowItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new WorkflowCreateShortcutDecorationsCommand(getEditingDomain(),
