...
import workflow.diagram.edit.policies.Activity2CanonicalEditPolicy;
import workflow.diagram.edit.policies.Activity2ItemSemanticEditPolicy;
...
public class Activity2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityName2EditPart) {
			((ActivityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WorkflowVisualIDRegistry.getType(ActivityName2EditPart.VISUAL_ID));
	}
