...
public class ParameterNameValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Parameter_3003, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ParameterNameValueEditPart.VISUAL_ID));
		}
		return parser;
	}
