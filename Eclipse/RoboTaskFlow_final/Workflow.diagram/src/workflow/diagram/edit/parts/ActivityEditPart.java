...
import workflow.diagram.edit.policies.ActivityCanonicalEditPolicy;
import workflow.diagram.edit.policies.ActivityItemSemanticEditPolicy;
...
public class ActivityEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActivityNameEditPart) {
			((ActivityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActivityLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WorkflowVisualIDRegistry.getType(ActivityNameEditPart.VISUAL_ID));
	}
