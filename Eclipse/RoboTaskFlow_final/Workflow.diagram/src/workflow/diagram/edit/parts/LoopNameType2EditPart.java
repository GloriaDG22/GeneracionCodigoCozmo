 ...
 * @generated
 */
public class LoopNameType2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopNameType2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Loop_3001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.LoopNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
