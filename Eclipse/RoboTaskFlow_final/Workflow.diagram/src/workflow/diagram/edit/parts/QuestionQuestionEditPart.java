 ...
 * @generated
 */
public class QuestionQuestionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuestionQuestionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Question_2005, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.QuestionQuestionEditPart.VISUAL_ID));
		}
		return parser;
	}
