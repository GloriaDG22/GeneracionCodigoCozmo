 ...
 * @generated
 */
public class AnswerAnswerEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AnswerAnswerEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Answer_2006, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.AnswerAnswerEditPart.VISUAL_ID));
		}
		return parser;
	}
