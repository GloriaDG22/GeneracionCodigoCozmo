	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WorkflowDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((WorkflowDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WorkflowDomainNavigatorItem((EObject) objects[i], parentElement,
