...
public class WorkflowNavigatorLinkHelper implements ILinkHelper {
	...
	*/
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = WorkflowDiagramEditorPlugin.getInstance().getDocumentProvider()
	...
	*/
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		WorkflowAbstractNavigatorItem abstractNavigatorItem = (WorkflowAbstractNavigatorItem) aSelection
				.getFirstElement();
