...
/**
 * This is the item provider adapter for a {@link workflow.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends TaskItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_type_feature", "_UI_Loop_type"),
				 WorkflowPackage.Literals.LOOP__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNumIterationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_numIterations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_numIterations_feature", "_UI_Loop_type"),
				 WorkflowPackage.Literals.LOOP__NUM_ITERATIONS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.WORKFLOW__LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__TASKS,
				 WorkflowFactory.eINSTANCE.createInitial()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__TASKS,
				 WorkflowFactory.eINSTANCE.createFinal()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__TASKS,
				 WorkflowFactory.eINSTANCE.createQuestion()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__TASKS,
				 WorkflowFactory.eINSTANCE.createAnswer()));
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__LINKS,
