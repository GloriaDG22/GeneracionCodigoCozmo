...
/**
 * This is the item provider adapter for a {@link catalogue.TaskDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskDefinitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskDefinition_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskDefinition_name_feature", "_UI_TaskDefinition_type"),
				 CataloguePackage.Literals.TASK_DEFINITION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CataloguePackage.Literals.TASK_DEFINITION__PARAMS_DEFINITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.TASK_DEFINITION__PARAMS_DEFINITIONS,
				 CatalogueFactory.eINSTANCE.createParameterDefinition()));
	}
