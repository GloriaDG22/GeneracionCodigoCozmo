...
public class CatalogueFactoryImpl extends EFactoryImpl implements CatalogueFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CataloguePackage.SIMPLE_TASK: return createSimpleTask();
			case CataloguePackage.COMPLEX_TASK: return createComplexTask();
			case CataloguePackage.PARAMETER_DEFINITION: return createParameterDefinition();
			default:
	...
	public ComplexTask createComplexTask() {
		ComplexTaskImpl complexTask = new ComplexTaskImpl();
		return complexTask;
	}
