...
public class CatalogueSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CataloguePackage.SIMPLE_TASK: {
				...
				if (result == null) result = caseTaskDefinition(simpleTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CataloguePackage.COMPLEX_TASK: {
				ComplexTask complexTask = (ComplexTask)theEObject;
				T result = caseComplexTask(complexTask);
				if (result == null) result = caseTaskDefinition(complexTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Complex Task</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Complex Task</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComplexTask(ComplexTask object) {
		return null;
	}
