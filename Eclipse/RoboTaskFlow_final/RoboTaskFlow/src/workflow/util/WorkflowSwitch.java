	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkflowPackage.ACTIVITY: {
				...
				if (result == null) result = caseTask(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case WorkflowPackage.QUESTION: {
				...
				if (result == null) result = caseTask(question);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.ANSWER: {
				...
				if (result == null) result = caseTask(answer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.LOOP: {
				...
				if (result == null) result = caseWorkflow(loop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
