...
public class WorkflowFactoryImpl extends EFactoryImpl implements WorkflowFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case WorkflowPackage.INITIAL: return createInitial();
			case WorkflowPackage.FINAL: return createFinal();
			case WorkflowPackage.QUESTION: return createQuestion();
			case WorkflowPackage.ANSWER: return createAnswer();
