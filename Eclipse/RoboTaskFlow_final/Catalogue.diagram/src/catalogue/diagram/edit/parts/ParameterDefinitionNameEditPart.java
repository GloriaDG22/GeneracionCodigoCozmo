 ...
 * @generated
 */
public class ParameterDefinitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParameterDefinitionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CatalogueParserProvider.getParser(CatalogueElementTypes.ParameterDefinition_3001,
					getParserElement(), CatalogueVisualIDRegistry
							.getType(catalogue.diagram.edit.parts.ParameterDefinitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
