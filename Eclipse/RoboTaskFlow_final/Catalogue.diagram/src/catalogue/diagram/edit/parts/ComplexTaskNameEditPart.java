...
import catalogue.diagram.edit.policies.CatalogueTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ComplexTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComplexTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CatalogueTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CatalogueElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CatalogueParserProvider.getParser(CatalogueElementTypes.ComplexTask_2002, getParserElement(),
					CatalogueVisualIDRegistry.getType(catalogue.diagram.edit.parts.ComplexTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CatalogueEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
