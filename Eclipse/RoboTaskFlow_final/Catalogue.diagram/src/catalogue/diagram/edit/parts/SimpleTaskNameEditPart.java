 ...
 * @generated
 */
public class SimpleTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CatalogueParserProvider.getParser(CatalogueElementTypes.SimpleTask_2001, getParserElement(),
					CatalogueVisualIDRegistry.getType(catalogue.diagram.edit.parts.SimpleTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
